...
class BookingController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('penyewa.bookings.index', compact('bookings'));
    }
    ...
    public function create(Request $request): View|RedirectResponse
    {
        ...
        return view('penyewa.bookings.create', compact('motor'));
    }
    ...
    public function show(Penyewaan $booking): View
    {
        ...
        return view('penyewa.bookings.show', compact('booking'));
    }
    ...
    public function edit(Penyewaan $booking): View|RedirectResponse
    {
        ...
        if ($booking->status !== BookingStatus::PENDING) {
            return redirect()->route('penyewa.bookings.show', $booking)
                ->with('error', 'Booking tidak dapat diedit karena sudah dikonfirmasi.');
        }

        $booking->load('motor.tarif');

        return view('penyewa.bookings.edit', compact('booking'));
    }
